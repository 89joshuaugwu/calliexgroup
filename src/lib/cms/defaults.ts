...
export const DEFAULT_HOME: HomeContent = {
  ...
  products: [
    { id: "product-0", order: 0, name: "B Cars", logoUrl: "", embedLink: "/products" },
    { id: "product-1", order: 1, name: "B Homes", logoUrl: "", embedLink: "/products" },
    { id: "product-2", order: 2, name: "Billpoint", logoUrl: "", embedLink: "/products" },
    { id: "product-3", order: 3, name: "Bitshop", logoUrl: "", embedLink: "/products" },
    { id: "product-4", order: 4, name: "Blunt", logoUrl: "", embedLink: "/products" },
    { id: "product-5", order: 5, name: "Dolla", logoUrl: "", embedLink: "/products" },
    { id: "product-6", order: 6, name: "Famous", logoUrl: "", embedLink: "/products" },
    { id: "product-7", order: 7, name: "Jetpay", logoUrl: "", embedLink: "/products" },
  ],
  innovation: {
